...
const containerId = process.env.COSMOS_IMPACT_HISTORY_CONTAINER || 'impact-history';
...
console.log(`${statusCode === 201 ? 'Created' : 'Verified'} history container ${databaseId}/${resource.id}.`);