...
function addDigestBranding(message, login) {
  ...
  const secondaryActions = `<div style="margin-top:10px"><a href="${escapeHtml(cardUrl)}" style="display:inline-block;margin-right:8px;color:#117a4b;padding:10px 13px;border:1px solid #117a4b;text-decoration:none;font-weight:700">Generate identity card</a><a href="${REPOSITORY_URL}" style="display:inline-block;color:#17211b;padding:10px 13px;border:1px solid #9aa8a0;text-decoration:none;font-weight:700">Star the repo</a></div>`;
  return {
    ...message,
