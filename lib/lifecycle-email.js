...
export function buildEmailVerificationEmail({ login, token }) {
  ...
  return {
    ...
    html: `<!doctype html><html lang="en"><body style="margin:0;background:#f3f6f4;color:#17211b;font-family:Arial,sans-serif"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f3f6f4;padding:32px 16px"><tr><td align="center"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #dce5df"><tr><td style="padding:28px 32px"><h1 style="margin:0 0 16px;font-size:28px;line-height:1.2">Verify your email</h1><p style="font-size:16px;line-height:1.6">Hi ${escapeHtml(greeting)},</p><p style="font-size:16px;line-height:1.6">Confirm this email address for your DevGlobe profile. This link expires in 24 hours and can be used once.</p><p style="margin:24px 0"><a href="${escapeHtml(url)}" style="display:inline-block;background:#117a4b;color:#ffffff;padding:12px 18px;text-decoration:none;font-weight:700">Verify email</a></p><p style="color:#5c6b62;font-size:13px;line-height:1.5">If you did not request this, you can ignore this message.</p></td></tr></table></td></tr></table></body></html>`,
  };
}
