...
DevGlobe does not publish OAuth authorization-server or protected-resource metadata. The current agent credentials are static bearer tokens, not OAuth grants.
